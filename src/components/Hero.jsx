  ...
  return (
    <div className='w-full mb-10'>
       <div className='md:px-[8rem] px-[3rem] md:flex md:mt-10 mt-10 mb-10'>
          <div><h1 className='text-white font-extrabold md:text-[5rem] text-[40px] tracking-tight'>Grow Your <span className='text-[#FCB218]'>Business</span> With Our <span className='text-[#FCB218]'>Logistics</span> Service</h1></div>
