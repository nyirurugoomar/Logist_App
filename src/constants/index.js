...
export const SuccessData = [

    {
        "id":"1",
        "number":"15k+",
        "description":"satisficed Customer"
    },
    {
      "id":"2",
      "number":"25+",
...
export const Services =[
    {
        ...
        "description":"Containerized cargo means general or wares that are shipped in reusable. commercial sized shipping containers."
    },
    {
        "id":"2",
        "color":"[#FF7222]",
